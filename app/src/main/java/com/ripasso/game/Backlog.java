...
public class Backlog {
    ...
    3. Add Super Villian that can kill Hero *Must be different gfx wise than "usual" villain (Owner Mathias Berneland) // FIXED

        5. Add graphical objects like health for hero on screen

            5.1 Hero should have health wich can be altered //FIXED
            5.2 Villian -||-    //FIXED
